...
void parse_args(int argc, char **argv)
{
   ...
   if (argc < 2)
     fout << "usage: treeminer -i<infile> -s <support>\n";
   else{
...
void enumerate_freq(Eqclass *eq, int iter)
{
   ...
   // cout << "  F" << iter << ": "
   //    << stats[iter-1].numlarge << " " << stats[iter-1].numcand << endl;
}
...
void main_func()
{
   ...
   ofstream summary("treeminer_summary.out", ios::app); 
   summary << "TREEMINER ";
   switch(sort_type){
